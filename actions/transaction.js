...
// Helper funtion to calculate  next Recurring date;
...
export async function scanReceipt(file) {
    try {
        ...
        // data generated will be in the form of this /``` JSON sdbkdesjbcbl  JSON```/ so we write regex to remove the unwanted part.
    ...
    try {
        ...
        const transaction  =  await db.$transaction(async (tx) => {
            const updated = await tx.transaction.update({
                ...
                data: {
                    ...data,
                    nextRecurringDate: data.isRecurring && data.recurringInterval ? calculateNextRecurringDate(data.date, data.recurringInterval)
                    : null,
                }
            })
